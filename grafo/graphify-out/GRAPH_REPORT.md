...
## Summary
- 365 nodes · 756 edges · 16 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `53441c44`
...
Cohesion: 0.09
Nodes (11): AplicacionPrincipal, Permite al superusuario o a un administrador indicar la última         Referenci, Panel de copias de seguridad. Solo lo ve el superusuario., Barras verticales: oficios recibidos por día., Barras verticales: oficios recibidos por mes., Gráfico de anillo con la distribución por estado., Barras horizontales: cantidad de oficios por responsable., Acorta el título de la cabecera cuando la ventana es estrecha.          `pack` n (+3 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (12): DialogoExportar, iniciar(), Coloca el calendario junto al campo, abriéndose hacia ARRIBA si no         cabe, Exporta a CSV los oficios de una fecha o de un rango de fechas., Exporta los oficios a un CSV acotando por fecha.      Siempre hay que elegir un, Campo para elegir un archivo: botón + nombre del archivo elegido.      Guarda la, Campo de fecha con calendario emergente. No requiere librerías externas.      Mu, `permitir_vacio=True` deja el campo en blanco y ofrece un botón         "Limpiar (+4 more)

### Community 5 - "Community 5"
Cohesion: 0.11
Nodes (11): Precarga el panel de edición con los datos del oficio seleccionado.          Sol, Guarda los cambios del panel según el rol: el gestor puede cambiar         respo, Sustituye el documento del oficio por si se cargó el equivocado., Carga un PDF con la respuesta del oficio seleccionado., Elimina el PDF adjunto (por si se cargó el archivo equivocado)., Texto que se muestra en los desplegables para un responsable.         Incluye el, Personas a las que se les puede asignar un oficio.          Un administrador no, A partir del texto del desplegable devuelve (usuario, nombre).         Para "(Si (+3 more)
...
Cohesion: 0.17
Nodes (5): Tablero con scroll vertical: tarjetas de indicadores y gráficos., Marco superior con logo y título., Crea la copia del día en segundo plano.          Va en un hilo aparte para que l, Convierte un contenedor en un área con scroll vertical.          Devuelve (lienz, Recuadro con título para agrupar campos afines.
...
- **Why does `AplicacionPrincipal` connect `Community 3` to `Community 4`, `Community 5`, `Community 7`, `Community 11`, `Community 12`, `Community 13`, `Community 14`?**
  _High betweenness centrality (0.432) - this node is a cross-community bridge._
- **Why does `SelectorFecha` connect `Community 4` to `Community 11`, `Community 5`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `VentanaIngreso` connect `Community 7` to `Community 4`?**
