...
## Summary
- 312 nodes · 652 edges · 18 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cc4f76a5`
...
Cohesion: 0.09
Nodes (41): actualizar_estado_asignado(), actualizar_oficio(), adjuntar_respuesta(), eliminar_respuesta(), filtrar_oficios(), _generar_referencia(), _guardar_registros(), _leer_registros() (+33 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (38): _cifrador(), cifrar(), descifrar(), obtener_clave(), Devuelve la clave Fernet; la genera la primera vez que se ejecuta., Descifra. Lanza cryptography.fernet.InvalidToken si el archivo     fue alterado, _buscar_recurso(), _crear_subcarpeta() (+30 more)
...
Cohesion: 0.20
Nodes (4): Carga un PDF con la respuesta del oficio seleccionado., Diálogo modal para escribir y confirmar una nueva contraseña.         Devuelve l, Busca solo entre los oficios visibles para el usuario en sesión., ¿El usuario en sesión puede gestionar a ese usuario? Se consulta         antes d
...
Cohesion: 0.25
Nodes (4): Refresca la vista al volver a la ventana.          Con varias personas usando la, Repuebla los desplegables de responsable con los usuarios actuales., True si el usuario en sesión puede crear/editar/eliminar usuarios         y reas, Guarda los cambios del panel según el rol: el gestor puede cambiar         respo

### Community 16 - "Community 16"
Cohesion: 0.25
Nodes (3): Elimina el PDF adjunto (por si se cargó el archivo equivocado)., Panel de búsqueda: por texto (Referencia UDC / Referencia oficio /         Causa, Devuelve la clave interna a partir de la etiqueta mostrada.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `AplicacionPrincipal` connect `Community 4` to `Community 3`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`?**
  _High betweenness centrality (0.433) - this node is a cross-community bridge._
- **Why does `SelectorFecha` connect `Community 8` to `Community 16`, `Community 11`, `Community 3`, `Community 12`?**
