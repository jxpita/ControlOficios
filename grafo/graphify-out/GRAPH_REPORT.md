# Graph Report - ControlOficios  (2026-09-04)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 693 nodes · 1370 edges · 45 communities (40 shown, 5 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 58 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9b8a3a48`
...
Cohesion: 0.10
Nodes (43): actualizar_estado_asignado(), actualizar_oficio(), corregir_oficio(), _empleado_de(), _exigir_cantidad_coherente(), _exigir_datos_para_finalizar(), _exigir_no_anulado(), filtrar_oficios() (+35 more)

### Community 1 - "SelectorFecha"
Cohesion: 0.20
...
Cohesion: 0.10
Nodes (33): anexar_texto(), _chmod(), escribir_bytes_protegido(), hacer_escribible(), proteger(), proteger_directorio(), Endurecimiento de permisos de los archivos que crea la aplicación. Objetivo:…, Devuelve el permiso de escritura al propietario si el archivo existe. (+25 more)

### Community 3 - "carga_masiva.py"
Cohesion: 0.07
Nodes (43): Comprueba TODAS las filas como si se fueran a guardar, sin guardar nada. Es la…, validar_importacion(), _a_fecha(), _a_texto(), agrupar_por_referencia(), _campos_comparables(), error_de_fila(), _error_formato() (+35 more)
...
### Community 5 - "almacen_oficios.py"
Cohesion: 0.13
Nodes (21): anular_oficio(), causales_registradas(), contar_por_tipo_accion(), esta_anulado(), hay_soporte_xlsx(), _leer_registros(), listar_implicados(), listar_oficios_visibles() (+13 more)
...
Cohesion: 0.18
Nodes (13): _encabezados_exportacion(), escribir_xlsx(), exportar_csv(), exportar_oficios(), exportar_xlsx(), _fila_exportacion(), filas_exportacion(), Valores de un oficio en el orden de COLUMNAS_EXPORTACION, con los saltos de… (+5 more)
...
### Community 29 - "generar_datos_prueba.py"
Cohesion: 0.21
Nodes (11): _fechas_recepcion(), generar_oficios(), _identificacion(), _mes_atras(), Genera el archivo de datos de prueba para la carga masiva. Crea `Matriz de…, Documento con el formato que exige cada tipo. La aplicación valida la cédula…, (año, mes) de la fecha indicada retrocediendo esa cantidad de meses., Fecha de recepción de cada oficio, repartida según los dos patrones. (+3 more)
...
Cohesion: 0.20
Nodes (3): DialogoMantenimiento, Corrige los datos de identificación de un oficio y permite retirarlo. Son los…, `permitir_vacio=True` deja el campo en blanco y ofrece un botón "Limpiar" en el…
...
- **Why does `SelectorFecha` connect `SelectorFecha` to `._construir_registro`, `DialogoExportar`, `aplicacion.py`, `.__init__`?**
