...
1. `AplicacionPrincipal` - 75 edges
...
Cohesion: 0.14
Nodes (25): listar_oficios(), _convertir_fecha(), dias_promedio_respuesta(), distribucion_estados(), distribucion_investigados(), _entero(), esfuerzo_por_oficio(), _mediana() (+17 more)
...
Cohesion: 0.11
Nodes (9): DialogoMantenimiento, Guarda los cambios del panel según el rol: el gestor puede cambiar         respo, Sustituye el documento del oficio por si se cargó el equivocado., Carga un PDF con la respuesta del oficio seleccionado., Elimina el PDF adjunto (por si se cargó el archivo equivocado)., Corrige los datos de identificación de un oficio, o lo retira., Corrige los datos de identificación de un oficio y permite retirarlo.      Son l, Busca solo entre los oficios visibles para el usuario en sesión.          Incluy (+1 more)
...
Cohesion: 0.13
Nodes (7): Deja el lienzo con su título y una explicación de por qué está vacío., Dispersión: investigados (eje X) frente a días de trabajo (eje Y).          Cada, Barras: cuántos oficios hay en cada tramo de investigados.          Sobre cada b, Barras verticales: oficios recibidos por día., Barras verticales: oficios recibidos por mes., Gráfico de anillo con la distribución por estado., Barras horizontales: cantidad de oficios por responsable.
...
- **Why does `AplicacionPrincipal` connect `Community 8` to `Community 2`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 15`, `Community 16`, `Community 17`?**
  _High betweenness centrality (0.410) - this node is a cross-community bridge._
- **Why does `SelectorFecha` connect `Community 14` to `Community 2`, `Community 10`, `Community 7`?**
